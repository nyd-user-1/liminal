...
const FEATURES: Array<{
...
}> = [
  {
    ...
    items: [
      ...
      { name: "InvoiceDetail", path: "billing/invoice-detail.tsx", desc: "Invoice header, actions, and line items." },
      { name: "InvoiceStatusBadge", path: "billing/invoice-status-badge.tsx", desc: "Maps invoice status → Badge variant." },
      { name: "NewInvoicePanel", path: "billing/new-invoice-panel.tsx", desc: "New-invoice SidePanel with client picker." },
      { name: "PayerPanel", path: "billing/payer-panel.tsx", desc: "New / edit payer SidePanel." },
      { name: "PrintActions", path: "billing/print-actions.tsx", desc: "Screen-only toolbar on the print view." },
      { name: "RecordPaymentModal", path: "billing/record-payment-modal.tsx", desc: "Record-payment Modal." },
    ],
  },
  {
    area: "Telehealth call",
    items: [
      { name: "CallStage", path: "call/call-stage.tsx", desc: "Full-viewport WebRTC telehealth stage." },
      { name: "CallHeader", path: "call/call-header.tsx", desc: "Top strip on the dark stage — camera chip + timer." },
      { name: "CallControls", path: "call/call-controls.tsx", desc: "Bottom control toolbar on the stage." },
      { name: "VideoTile", path: "call/video-tile.tsx", desc: "Participant surface on the dark stage." },
  ...
  },
  {
    area: "Forms & intake",
    items: [
      { name: "FormBuilder", path: "forms/form-builder.tsx", desc: "Palette · question cards · settings builder." },
      { name: "FormsTemplates", path: "forms/forms-templates.tsx", desc: "Forms tab of the Templates page." },
      { name: "IntakeWizard", path: "forms/intake-wizard.tsx", desc: "Portal intake wizard — Stepper-driven fill." },
      { name: "SendFormModal", path: "forms/send-form-modal.tsx", desc: "'Send to client' modal." },
    ],
  },
  {
    area: "Messaging",
    items: [
      { name: "InboxList", path: "messaging/inbox-list.tsx", desc: "Practitioner inbox — Compose + Open/Closed tabs." },
      { name: "ThreadView", path: "messaging/thread-view.tsx", desc: "Shared secure-messaging thread pane." },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "ClientNotes", path: "notes/client-notes.tsx", desc: "Client Documentation tab." },
      { name: "NoteSheet", path: "notes/note-sheet.tsx", desc: "Full-screen slide-up document surface." },
      { name: "ScribePanel", path: "notes/scribe-panel.tsx", desc: "Docked AI Scribe panel on the call screen." },
      { name: "AskAiPanel", path: "notes/ask-ai-panel.tsx", desc: "Ask-AI chat panel in a SidePanel." },
  ...
  },
  {
    area: "Shell",
    items: [
      { name: "AppShell", path: "shell/app-shell.tsx", desc: "Sidebar + main column (TopBar + canvas)." },
      { name: "Sidebar", path: "shell/sidebar.tsx", desc: "Navy nav column + bottom-left account menu." },
      { name: "TopBar", path: "shell/topbar.tsx", desc: "White top strip — title + bell + avatar menu." },
        ...
        <div className="space-y-10">
          <Group title="Actions">
            ...
            <Spec name="TextLink" desc="Inline primary link; optional leading icon.">
              <TextLink href="#">View all clients</TextLink>
