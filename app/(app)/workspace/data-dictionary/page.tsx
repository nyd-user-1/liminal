...
// /admin/data renders, reached from the Workspace content tabs rather than the
// admin-only URL. The panel component is reused (not forked); this page only
// fetches the inventory and sits it under the BoardTabs. Aggregate counts only,
// never a PHI read.
