...
export async function BriefingCard() {
  // "cached" — this legacy page must never spend an API call on render; the
  // model runs only from the Insights switch. Shows whatever Insights last
  // generated, or the off state.
  const b = await platformBriefing("cached");
