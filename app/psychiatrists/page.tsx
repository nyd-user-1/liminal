    ...
    <div className="flex min-h-screen flex-col bg-page">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-12 sm:py-16">
        <div className="relative overflow-hidden rounded-card">
          <img
            src="https://c1vijjkvyt1skkfe.public.blob.vercel-storage.com/hope-sails-2.avif"
            alt="A watercolour illustration — a sailboat with a sail reading &quot;hope&quot; cuts through waves toward a sunset horizon."
