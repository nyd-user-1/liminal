  ...
  return (
    <div className="flex h-dvh overflow-hidden bg-page">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 overflow-y-auto border border-border bg-surface p-4 pb-[calc(1rem_+_env(safe-area-inset-bottom))] [scrollbar-width:none] md:rounded-tl-2xl md:p-6 md:pb-6 [&::-webkit-scrollbar]:hidden">
