  ...
  return (
    <div ref={ref} className="relative hidden md:block">
      <button
        ...
        className={`flex h-9 items-center gap-1.5 rounded-field bg-black/[0.04] pl-3 pr-2 text-[14px] text-text transition-colors ${
          open ? "bg-black/[0.06]" : "hover:bg-black/[0.06]"
        }`}
      >
...
function SearchTrigger() {
  ...
  return (
    <button
      ...
      onClick={open}
      aria-label="Search"
      className="group flex h-9 items-center gap-2 rounded-field bg-black/[0.04] px-2.5 text-text-muted transition-colors hover:bg-black/[0.06] hover:text-text md:w-64"
    >
