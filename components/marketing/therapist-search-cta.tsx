...
// posts to /providers, composed from the kit SearchInput + Button. Used on the
...
export function TherapistSearchCta({
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 text-center">
      ...
      <form action="/providers" className="mx-auto mt-8 flex max-w-xl flex-col gap-3 sm:flex-row">
